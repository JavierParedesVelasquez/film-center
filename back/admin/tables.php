        ...
        <div class="page-wrapper">
            ...
            <div class="page-header row no-gutters py-4">
                <div class="col-12  text-center text-sm-left mb-0">
                    <h3 class="page-title">USUARIOS CLIENTES</h3>
                </div>
            </div>
            <!--End Page Header-->
            <!--Default Light Table-->
                ...
                <div class="col">
                    <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                            <div class="card-header border-bottom">
                                    <button class="btn btn-primary" onclick="personanueva()" data-toggle="modal" data-target="#exampleModal">Nueva Persona</button>
                            </div>
                        </div>
                            ...
                            <table class="table mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">dni</th>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txtnombres" value="">
                    </div>
                    <div class="form-group">
                        <label for="txtapellidos">apellidos:</label>
                        <input type="text" class="form-control" id="txtapellidos" value="">
                    </div>
                    <div class="form-group">
                        <label for="txtdni">DNI:</label>
                        <input type="text" class="form-control" id="txtdni" value="">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="personaguardar()">Guardar</button>
                  </div>
                </div>
              </div>
            </div>
