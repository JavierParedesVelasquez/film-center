...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/icon-administradores.svg">
    <!-- Custom CSS -->
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header row no-gutters py-4">
                <div class="col-12  text-center text-sm-left mb-0">
                    <h3 class="page-title">USUARIO ADMINISTRADOR</h3>
                </div>
            </div>
            <!--End Page Header-->
            <!--Default Light Table-->
                ...
                <div class="col">
                    <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                            <div class="card-header border-bottom">
                                    <button class="btn btn-primary" onclick="usuarionuevo()" data-toggle="modal" data-target="#exampleModal">Nueva Usuario</button>
                            </div>
                        </div>
    ...
    <script type="text/javascript">personalist2()</script>
