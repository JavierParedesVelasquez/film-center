...
$sql = "SELECT * FROM home WHERE id_pelicula = $pelidulaId";
...
<div class="main">
    <div class="container">
        <div class="row colum1">
            ...
            <div class="col-8 div_medio">
                <h2 class="title1"><?php echo $reg->nombre_pelicula; ?></h2>
                <p><?php echo $reg->categoria; ?> | <?php echo $reg->tiempo; ?> | <?php echo $reg->calificacion; ?></p>
            </div>
            <div class="col div_derecha">
                <a href="../back/venta2.php?peliculaId=<?php echo $reg->id_pelicula; ?>" class="card-lin btn btn-danger"><i class="fa-solid fa-cart-shopping"></i> Comprar</a>
            </div>
        </div>
        <div class="row colum2">
            <div class="col"></div>
            <div class="col-4">
                <img src="../img/home/<?php echo $reg->imagen; ?>" class="img-fluid foto_peli">
            </div>
