    ...
    <div class="container">
        <div class="row colum1">
            ...
            <div class="col div_derecha">
                <a href="../back/venta.php?peliculaId=<?php echo $reg->id_pelicula; ?>" class="card-lin btn btn-danger"><i class="fa-solid fa-cart-shopping"></i> Comprar</a>
            </div>
        </div>
        <div class="row colum2">
            <div class="col"></div>
            <div class="col-4">
                <img src="../img/<?php echo $reg->imagen; ?>" class="img-fluid foto_peli">
            </div>
