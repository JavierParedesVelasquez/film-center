...
<div class="container">
    <div class="row">
        ...
        <h3><?php echo $reg->nombre_pelicula; ?></h3>
        <div class="col-lg-4">
            <img src="../img/home/<?php echo $reg->imagen; ?>" class="card-img-top">
            <br>
            <br>
           ...
           <h3 class="text-center">Datos del cliente</h3>
            <div class="row text-center">
                ...
                <form action="procesar-venta.php" method="post">
                    ...
                    <br><br>
                    <div class="col-lg-2">
                        <button class="btn btn-success bnt-lg btn-block" type="submit">Pagar</button>
                    </div>
                </form>
